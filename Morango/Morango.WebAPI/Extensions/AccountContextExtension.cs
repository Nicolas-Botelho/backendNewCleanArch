...
using RequestAuth = Morango.Application.Security.Account.UseCases.Authenticate.Request;
using RequestChangePassword = Morango.Application.Security.Account.UseCases.ChangePassword.Request;
using RequestRefreshToken = Morango.Application.Security.Account.UseCases.RefreshToken.Request;
using RequestResetPasswordCode = Morango.Application.Security.Account.UseCases.SendResetPassword.Request;
using RequestSaveRefreshToken = Morango.Application.Security.Account.UseCases.SaveRefreshToken.Request;
using RequestToken = Morango.Application.Security.Account.UseCases.Verify.Request;
using RequestUser = Morango.Application.Security.Account.UseCases.Create.Request;
using ResponseAuth = Morango.Application.Security.Account.UseCases.Authenticate.Response;
using ResponseChangePassword = Morango.Application.Security.Account.UseCases.ChangePassword.Response;
using ResponseResetPasswordCode = Morango.Application.Security.Account.UseCases.SendResetPassword.Response;
using ResponseSaveRefreshToken = Morango.Application.Security.Account.UseCases.SaveRefreshToken.Response;
using ResponseUser = Morango.Application.Security.Account.UseCases.Create.Response;
